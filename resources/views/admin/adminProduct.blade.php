    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header" >
                <a href="index-2.html"><img class="main-logo" src="{{url('public')}}/admin/img/logo/Logoweb.png" alt="" style="height: 100px; width: 200px"/></a>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="logo-pro" >
                        <a href="index-2.html"><img class="main-logo" src="{{url('public')}}/admin/img/logo/Logoweb.png" alt="" style="height: 50px; width: 100px"/></a>
                    </div>
                </div>
            </div>
        </div>
