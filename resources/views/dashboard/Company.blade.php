    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <div class="mobile-nav">
            ...
            <div class="amado-navbar-brand">
                <a href="#"><img src="{{ url('public') }}/fe/img/core-img/logo (2).png" alt=""></a>
            </div>
            <!-- Navbar Toggler -->
        ...
        <header class="header-area clearfix">
            ...
            <!-- Logo -->
            <div class="logo">
                <a href="{{ url('Home') }}"><img src="{{ url('public') }}/fe/img/core-img/logo (2).png"
                        alt=""></a>
            </div>
            <!-- Amado Nav -->
            <nav class="amado-nav">
        ...
        <div class="w3-content w3-section" style="max-width:1000px">
            <img class="mySlides" src="{{ url('public') }}/fe/img/bg-img/hinh1.jpeg">
            <img class="mySlides" src="{{ url('public') }}/fe/img/bg-img/hinh2.jpg">
            <img class="mySlides" src="{{ url('public') }}/fe/img/bg-img/hinh3.jpg">
            <img class="mySlides" src="{{ url('public') }}/fe/img/bg-img/hinh4.jpg">
        </div>
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="single_widget_area">
                            ...
                            <div class="footer-logo mr-50">
                                <a href="{{ url('Home') }}"><img
                                        src="{{ url('public') }}/fe/img/core-img/logo (2).png" alt=""></a>
                            </div>
                            <!-- Copywrite Text -->
                            <p class="copywrite">
