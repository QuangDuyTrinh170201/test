...
<body>
    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <header class="header-area clearfix">
            ...
            <!-- Logo -->
            <div class="logo">
                <a href="{{url('Home')}}"><img src="{{ url('public') }}/fe/img/core-img/logo (2).png" alt=""></a>
            </div>
            <!-- Amado Nav -->
            <nav class="amado-nav">
                <ul>
        ...
        <div class="products-catagories-area clearfix">
            <div class="amado-pro-catagory clearfix">
                ...
                <div class="single-products-catagory clearfix">
                    <a href="#">
                        <img src="{{url('public')}}/fe/img/bg-img/admin2.jpg" alt="" style="height: 700px; width: 500px;">
                        <!-- Hover Content -->
                ...
                <div class="single-products-catagory clearfix">
                    <a href="#">
                        <img src="{{url('public')}}/fe/img/bg-img/admin1.jpg" alt="" style="height: 700px; width: 500px;">
                        <!-- Hover Content -->
                        <div class="hover-content">
                            <div class="line"></div>
